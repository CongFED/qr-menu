...
export default function AdminLoginPage() {
  ...
  const [email, setEmail] = useState('admin@suoidahongiao.vn');
      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100 animate-fade-in">
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Hệ thống nhà hàng Suối Đá Hòn Giao
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="admin@suoidahongiao.vn"
              required
            />
          </div>
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 text-center">
          <p className="text-[11px] text-slate-400">
            Tài khoản mẫu: <span className="font-mono text-slate-700">admin@suoidahongiao.vn</span> / <span className="font-mono text-slate-700">Admin@123</span>
          </p>
        </div>
      </div>
    </div>
